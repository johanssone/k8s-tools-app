...
1. Use the `https://github.com/johanssone/k8s-tools-app.git` git repository.
...
1. If you've forked/cloned this repository, you'll need to do a global find/replace for `https://github.com/johanssone/k8s-tools-app.git` and change it to your new repository.
